...
describe('features/demo/engine/logic/export barrel', () => {
  ...
  it('adds nothing to the persisted snapshot — export state is ephemeral by design', () => {
    ...
    // 7 since P7.2/P7.3 added the analyst profile and the form overrides — this assertion is
    // about the EXPORT module adding nothing, so it tracks the live version rather than pinning
    // a number this module never moves.
